...
class RoomMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_message" do
    assert_difference("RoomMessage.count") do
      post room_messages_url, params: { room_message: { message: @room_message.message, room_id: @room_message.room_id, user_id: @room_message.user_id } }
    end
  ...
  test "should update room_message" do
    patch room_message_url(@room_message), params: { room_message: { message: @room_message.message, room_id: @room_message.room_id, user_id: @room_message.user_id } }
