  ...
  def create
    ...
    respond_to do |format|
      if @room_message.save
        format.html { redirect_to room_message_url(@room_message), notice: "Room message was successfully created." }
  ...
  def update
    respond_to do |format|
      if @room_message.update(room_message_params)
        format.html { redirect_to room_message_url(@room_message), notice: "Room message was successfully updated." }
